...
public static class PositionCalculator
{
    ...
    /// </summary>
    [Pure]
    public static Point CalculateTouchDockedPosition(Size container, Rect touch, int spacing)
    {
    ...
    public static Rect CalculateNewDockedPosition(Size oldSize, Rect touchRect, Size newSize, int spacing)
    {
        ...
        var legalPosition = CalculateTouchDockedPosition(oldSize, touchRect, spacing);
        ...
        var touchSize = new Size(touchRect.Width, touchRect.Height);
